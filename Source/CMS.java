...
public class CMS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Till Management System (USER)");
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jAcHolderCost, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jAcHolderProducts, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jAcHolderCustomer, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jInsertMarketItems.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.SHIFT_MASK));
        ...
        jInsertCookingItems.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.SHIFT_MASK));
        ...
        jDeleteMarketItems.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.ALT_MASK));
        ...
        jDeleteCookingItems.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.ALT_MASK));
 ...
 Chocolate o = new Chocolate();
    ...
    private void jSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSaveActionPerformed
         ...
         Statement st3;
                ...
                try {
                    ...
                    while(rs3.next())
                    {
                        ...
                        {
                          if(AcCName.equals("Customer Name"))
        {
        ...
        try {
            ...
            while(rs6.next())
            {
            st16.executeUpdate("insert into History values ("+rs6.getInt("pnumber")+","+rs6.getDouble("pcost")+",'"+rs6.getString("ptype")+"','Account Holder','"+date1+"','"+rs6.getString("pname")+"','"+AcCName+"','"+UserLogIn.SellerName+"')");
            }
    ...
    double tCos = 0;
        ...
        try {
            ...
            st1 = con.createStatement();
              while(rs.next())
                {
                st1.executeUpdate("insert into AcHolderData values  ('"+AcCName+"','"+rs.getString("pname")+"',"+rs.getInt("pnumber")+","+rs.getDouble("pcost")+",'"+rs.getString("ptype")+"','"+date+"')");
                }
                JOptionPane.showMessageDialog(null,AcCName+" Account is Updated");
                rs1= st.executeQuery("SELECT MR,PP FROM AcHolderMoney Where CName='"+AcCName+"'");
                rs1.next();
                double MR = rs1.getDouble("MR");
                MR+=tCos;
                int PP=rs1.getInt("PP");
                PP+=tPro;
                st1.executeUpdate("update AcHolderMoney set MR="+MR+",PP="+tPro+" where CName='"+AcCName+"'");
...
Namakin o = new Namakin();                                                   
    ...
    private void jAcHolderMakeReciptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAcHolderMakeReciptActionPerformed
       ShowR1 o = new ShowR1(); // TODO add your handling code here:
