...
import static canteenmanagementsystem.CMS1.AcCName;
...
public class ShowR111 {
    ...
    public ShowR111()
    {
        ...
        try {
            ...
            rs2= st2.executeQuery("SELECT MR,PP FROM AcHolderMoney Where CName='"+(String) CMS1.jAcHolderCustomer.getSelectedItem()+"'");
                rs2.next();
                MR = rs2.getDouble("MR");
                PP=rs2.getInt("PP");
                rs2.close();
            ...
            Logger.getLogger(ShowR111.class.getName()).log(Level.SEVERE, null, ex);
        }
                ...
                JLabel CName1 = new JLabel((String) CMS1.jAcHolderCustomer.getSelectedItem());
