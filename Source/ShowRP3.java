...
import static canteenmanagementsystem.CMS1.jAcHolderCustomer;
import static canteenmanagementsystem.CMS1.jBiscuitsCost;
import static canteenmanagementsystem.CMS1.jBiscuitsNumber;
import static canteenmanagementsystem.CMS1.jChipsCost;
import static canteenmanagementsystem.CMS1.jChipsNumber;
import static canteenmanagementsystem.CMS1.jChocolateCost;
import static canteenmanagementsystem.CMS1.jChocolateNumber;
import static canteenmanagementsystem.CMS1.jColdDrinksCost;
import static canteenmanagementsystem.CMS1.jColdDrinksNumber;
import static canteenmanagementsystem.CMS1.jCookingCost;
import static canteenmanagementsystem.CMS1.jCookingNumber;
import static canteenmanagementsystem.CMS1.jNamakinCost;
import static canteenmanagementsystem.CMS1.jNamakinNumber;
import static canteenmanagementsystem.CMS1.jOtherCost;
import static canteenmanagementsystem.CMS1.jOtherNumber;
...
public class ShowRP3 {
    ...
    public ShowRP3()
    {
        ...
        try {
            ...
            while(rs.next())
            {
            st1.executeUpdate("insert into History values ("+rs.getInt("pnumber")+","+rs.getDouble("pcost")+",'"+rs.getString("ptype")+"','Temporary','"+date+"','"+rs.getString("pname")+"','"+jTempCustomer.getText()+"','"+AdminLogIn.SellerName+"')");
            }
        ...
        CMS1.jTempProducts.setText(null);
        CMS1.jAcHolderProducts.setText(null);
        CMS1.jAcHolderCost.setText(null);
        CMS1.jTempCost.setText(null);
        CMS1.jTotalNumber.setText(null);
        CMS1.jTotalCost.setText(null);
                        }
                    rs4.close();
                    rs5.close();
                    }
